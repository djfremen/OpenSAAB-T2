...
with zipfile.ZipFile(unsigned, 'a') as archive:
    ...
    archive.writestr('assets/build.json', json.dumps({'source_commit':commit, 'source_repository':'https://github.com/djfremen/OpenSAAB-T2', 'product':'OpenSAAB Setup', 'version':'0.3.1'}))
