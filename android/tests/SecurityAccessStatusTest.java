...
public final class SecurityAccessStatusTest {
    ...
    public static void main(String[] args)throws Exception{
        ...
        try{
            ...
            check(!s.imported()&&s.summary(true,true,false).contains("not yet verified"),"Started request implies success");
            ...
            s.save(file);s=SecurityAccessStatus.read(file);
            check(!s.imported()&&s.details(true,false).contains("NOT VERIFIED"),"API response implies vehicle grant");
            ...
            check(s.summary(true,true,true).contains("not yet verified"),"Import implies vehicle grant");
            check(s.summary(false,false,true).contains("session stopped"),"Disconnect not reflected");
