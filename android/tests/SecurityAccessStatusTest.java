...
public final class SecurityAccessStatusTest {
    ...
    public static void main(String[] args)throws Exception{
        ...
        try{
            ...
            check(s.summary(true,true,true).startsWith("Security data loaded"),"Import implies vehicle grant");
            check(s.summary(false,false,true).startsWith("Security data loaded"),"Stopped session hid completed import");
