...
The live preview 11 run selected 2004 / 9440 and imported the API response successfully. Preview 12 completed a live Pixel 7 / Chipsoft / 2004 NG 9-3 run: menu navigation took about 3.3 seconds, the processed data loaded, and full native firmware restarted automatically. The owner reported a successful rear parking-sensor module re-add. The corresponding 32-bit headunit.6 build still requires a live head-unit test.
